...
document.getElementById(
  "spring-output-ios-spring-response-dampingRatio"
).innerHTML = `let animation = Animation.spring(response: <span class="output-args output-response"></span>, dampingRatio: <span class="output-args output-dampingRatio"></span>);`;

document.getElementById(
  "spring-output-ios-spring-mass-stiffness-damping"
).innerHTML = `let animation = Animation.spring(mass: <span class="output-args output-mass"></span>, stiffness: <span class="output-args output-stiffness"></span>, damping: <span class="output-args output-damping"></span>);`;
